...
const capabilitiesRaw = [
  ...
  },
  {
    ...
    ko: "공지 작성, 댓글·쪽지 대응, 신규 채널 운영 등 커뮤니티와 직접 소통하며 유저 경험을 개선합니다.",
    en: "Announcements, comment and DM response, running new channels — I talk to the community directly and improve the user experience.",
